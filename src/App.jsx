...
//cs
import StaticWebApplicationDevelopmentServices from './CS/WebApp/StaticWebAppDev'
import DynamicWebApplicationsDevelopmentCenter from './CS/WebApp/DynamicWebAppDev'
import MobileAppDevelopmentServices from './CS/WebApp/MobileAppDev'
import AnimationsProjectDevelopmentCenter from './CS/WebApp/Animation'
import AIProjectDevelopmentCenter from './CS/Ai/Ai'
import DataScienceProjectDevelopmentCenter from './CS/Data/DataScience'
import BigDataProjectDevelopmentCenter from './CS/BigData/BigData'
import BlockchainProjectDevelopmentCenter from './CS/Blockchain/BlockChain'
import CybersecurityProjectDevelopmentCenter from './CS/Cybersecurity/Cybersecurity'
import DevOpsProjectDevelopmentCenter from './CS/DevOps/DevOps'
import NetworkingProjectDevelopmentCenter from './CS/Networking/Networking'
import ImageProcessingProjectDevelopmentCenter from './CS/Processing/Ipp'
import NLPProjectDevelopmentCenter from './CS/Processing/Nlp'
import CloudComputingProjectDevelopmentCenter from './CS/Cloud/Cloud'
...
const App=()=>{
 ...
 <div className="app">
      ...
      {/* telangana */}
        ...
        <Route path="cs" element={<StaticWebApplicationDevelopmentServices />} />
        <Route path="cs1" element={<DynamicWebApplicationsDevelopmentCenter />} />
        <Route path="cs2" element={<MobileAppDevelopmentServices />} />
        <Route path="cs3" element={<AnimationsProjectDevelopmentCenter />} />
        <Route path="ai" element={<AIProjectDevelopmentCenter />} />
        <Route path="data" element={<DataScienceProjectDevelopmentCenter />} />
        <Route path="bigdata" element={<BigDataProjectDevelopmentCenter />} />
        <Route path="blockchain" element={<BlockchainProjectDevelopmentCenter />} />
        <Route path="devops" element={<DevOpsProjectDevelopmentCenter />} />
        <Route path="networking" element={<NetworkingProjectDevelopmentCenter />} />
        <Route path="ipp" element={<ImageProcessingProjectDevelopmentCenter />} />
        <Route path="nlp" element={<NLPProjectDevelopmentCenter />} />
        <Route path="cloud" element={<CloudComputingProjectDevelopmentCenter />} />
        <Route path="cyber" element={<CybersecurityProjectDevelopmentCenter />} />

    {/* ECE */}
        <Route path="1" element={<BiomedicalElectronicsProjectDevelopmentCenter />} />
        ...
        <Route path="2" element={<CommunicationSystemsProjectDevelopmentCenter />} />
        ...
        <Route path="3" element={<ControlSystemsAndRoboticsProjectDevelopmentCenter />} />
       ...
       <Route path="4" element={<CryptographyAndSecurityProjectDevelopmentCenter />} />
        ...
        <Route path="5" element={<EmbeddedSystemsProjectDevelopmentCenter />} />
        ...
        <Route path="6" element={<IoTProjectDevelopmentCenter />} />
        ...
        <Route path="7" element={<SignalProcessingProjectDevelopmentCenter />} />
        ...
        <Route path="8" element={<VLSIDesignAndEmbeddedSystemsProjectDevelopmentCenter />} />
        ...
        <Route path="9" element={<WirelessSensorNetworksProjectDevelopmentCenter />} />
        ...
        <Route path="10" element={<SatelliteSpaceCommunicationProjectDevelopmentCenter />} />
        ...
        <Route path="11" element={<AntennasProjectDevelopmentCenter />} />
        ...
        {/*EEE  */}
        <Route path="eee1" element={<EEEPowerSystemsProjectDevelopmentCenter />} />
                 <Route path="eee1-1-1" element={<EEELoadFlowAnalysis />} />

        <Route path="eee2" element={<EEEElectricalMachinesProjectDevelopmentCenter />} />
        <Route path="eee3" element={<EEEPowerElectronicsProjectDevelopmentCenter />} />
        <Route path="eee4" element={<EEERenewableEnergySystemsProjectDevelopmentCenter />} />
                 <Route path="eee4-4-1" element={<EEESolarPhotovoltaicSystems />} />
                 <Route path="eee4-4-2" element={<EEEWindEnergyConversionSystems   />} />

        <Route path="eee5" element={<EEEEmbeddedSystemsProjectDevelopmentCenter />} />
        <Route path="eee6" element={<EEEHighVoltageEngineeringProjectDevelopmentCenter />} />
        <Route path="eee7" element={<EEESmartGridMicrogridProjectDevelopmentCenter />} />
        <Route path="eee8" element={<EEEControlSystemsProjectDevelopmentCenter />} />
        <Route path="eee9" element={<EEEIndustrialAutomationProjectDevelopmentCenter />} />
        <Route path="eee10" element={<EEEElectricVehiclesProjectDevelopmentCenter />} />
        <Route path="eee11" element={<EEEArtificialIntelligenceProjectDevelopmentCenter />} />
        ...
        <Route path="eee12" element={<EEEIoTProjectDevelopmentCenter />} />
        ...
        <Route path="eee13" element={<EEEEnergyManagementSystemsProjectDevelopmentCenter />} /> 
        ...
        <Route path="civil-1" element={<ConstructionProjectManagement />} />
        ...
        <Route path="civil-2" element={<EnvironmentalEngineering />} />
        ...
        <Route path="civil-3" element={<GeotechnicalEngineering />} />
        ...
        <Route path="civil-4" element={<RemoteSensingGIS />} />
                <Route path="civil-4-1" element={<GISbasedUrbanPlanning />} />
                {/* <Route path="civil-4-2" elemant={<RemoteSensingforDisaster />} /> */}

        <Route path="civil-5" element={<StructuralEngineering />} />
        ...
        <Route path="civil-6" element={<TransportationEngineering />} />
        ...
        <Route path="mech-1" element={<METhermalEngineeringHeat />} />
        ...
        <Route path="mech-2" element={<FluidMechanicsFluidDynamics />} />
        ...
        <Route path="mech-3" element={<ManufacturingProductionEngineering />} />
        ...
        <Route path="mech-4" element={<DesignEngineerCAD />} />
        ...
        <Route path="mech-5" element={<RoboticsMechatronics />} />
        ...
        <Route path="mech-6" element={<RenewableEnergyThermal />} />
        ...
        <Route path="mech-7" element={<AutomotiveVehicleEngineering />} />
        ...
        <Route path="mech-8" element={<MechatronicsControlSystems />} />       
        ...
        <Route path="mech-9" element={<MechanicalProperties />} />
        ...
        <Route path="mech-10" element={<IndustrialProductionOptimization />} />
